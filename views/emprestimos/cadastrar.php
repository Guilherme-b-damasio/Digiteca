...
include('../../layout/navbar.php');
 ...
 ?>
	...
	<div class="container mx-auto mt-4">
		...
		<form action="/DB/emprestimos/cadastrar.php" method="post">
			...
			<div class="form-group">
    			...
    			<input class="form-control" id="data_emprestimo" name= "txtDATA_EMPRESTADO" type="date" value="<?php echo obter_data_dd_mm_yyyy(); ?>">
			</div>
